...
class SenderPi(object):
    ...
    def open_connection(self):
        self._connection = pika.BlockingConnection(pika.ConnectionParameters(host='tabor.cs.kotnet.kuleuven.be', port=5672, credentials=pika.PlainCredentials('geel', 'geel')))
